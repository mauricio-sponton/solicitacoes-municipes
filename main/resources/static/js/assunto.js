...
$(document).ready(function () {
    ...
    var table = $('#table-assuntos').DataTable({
    	"language":{
        ...
        ajax: {
            url: '/assuntos/datatables/server'
...
//	                		excluir = ''
//	                	}else{
//	                		excluir = '<a id="btn-del-cliente" class="btn-tabela btn-tabela-excluir" href="/assuntos/excluir/'+ 
//	                		id +'" role="button" title="Excluir" data-toggle="modal" data-target="#confirm-modal"><i class="fas fa-trash-alt"></i></a>'
//	                	}
	                    return '<a class="btn-tabela btn-tabela-editar" href="/assuntos/editar/'+ 
...
//	                     excluir	                	
    ...
    var alvo = '#table-assuntos';
    var objeto = "/assuntos"
    
    $("#table-assuntos thead").on('click', 'tr', function() {		
		table.buttons().disable();
	});
